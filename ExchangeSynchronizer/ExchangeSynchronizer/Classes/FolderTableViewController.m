...
-(void)initFolder
{
	...
	[folders addObject:@"ALL"];
	[folders addObject:@"other"];
	currentFolder = [folders objectAtIndex:0];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	currentFolder = [[[tableView cellForRowAtIndexPath:indexPath]textLabel]text];
	[[NSNotificationCenter defaultCenter] postNotificationName:@"FolderChanged" object:nil];
